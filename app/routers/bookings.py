...
# Serializes the conflict-check + quota-check + insert sequence in
# create_booking, and separately the status-check + refund + insert sequence
# in cancel_booking, so concurrent requests can't both pass a check before
